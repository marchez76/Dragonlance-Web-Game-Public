...
Rapporto completo in `dati/RAPPORTO-bestiario.md`. **6 creature convertite** in `dati/mostri/` (le altre restano da fare: vedi "Il conteggio vero del bestiario" e "Parte 5" nel rapporto per il numero, che non è ancora definitivo).
